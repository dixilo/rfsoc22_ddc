...
set dp_aux_data_oe_inv [create_bd_cell -type ip -vlnv [latest_ip util_vector_logic] dp_aux_data_oe_inv]
set_property -dict [ list \
    CONFIG.C_OPERATION {not} \
    CONFIG.C_SIZE {1} \
] $dp_aux_data_oe_inv

connect_bd_net [get_bd_pins dp_aux_data_oe_inv/Op1] [get_bd_pins zynq_ultra_ps_e_0/dp_aux_data_oe_n]
